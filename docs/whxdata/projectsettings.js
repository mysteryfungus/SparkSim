...
rh = window.rh;
model = rh.model;
var defaultTopic = "Lessons/Lesson_1.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("Lessons/Lesson_1.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '207d9ce7-b8a8-4e7a-9391-aeab513dab79' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "SparkSim Wiki");
